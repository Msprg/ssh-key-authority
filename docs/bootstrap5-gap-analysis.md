...
| Help `/help` | `templates/help.php` | Mixed | Accordion now runs on native collapse behavior, local SKA card markup, semantic iconography, and local image/clear helpers via `keygen_help()` | Bootstrap 3 content styling remains |
