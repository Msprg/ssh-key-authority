...
<form method="post" action="<?php outurl($this->data->relative_request_url)?>">
	...
	<div class="mb-3"><button type="submit" data-confirm="Send mail? Are you sure?" class="btn btn-primary btn-lg w-100">Send bulk mail to <?php out(str_replace('_', ' ', $this->get('recipients')))?></button></div>
</form>
